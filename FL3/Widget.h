//
// "$Id: Widget.h 6912 2009-10-02 19:08:55Z matt $"
//
...
// 10/12/2009, Matt: first simple merge for FLTK3 port

/* \file
   fltk::Widget, Fl_Label classes . */
...
namespace fltk {
  ...
  typedef void (Callback )(fltk::Widget*, void*);
  /** Default callback type pointer definition for all fltk widgets */
  typedef Callback* Callback_p; // needed for BORLAND
  /** One parameter callback type definition passing only the widget */
  typedef void (Callback0)(fltk::Widget*);
  /** Callback type definition passing the widget and a long data value */
  typedef void (Callback1)(fltk::Widget*, long);
}
...
/** Widget is the base class for all widgets in FLTK.  
...
namespace fltk {
  ...
  public:
    ...
    /** Creates a widget at the given position and size.
     ...
     The Widget is a protected constructor, but all derived widgets have a 
     ...
     */
    Widget(int x, int y, int w, int h, Fl_CString label=0L);
    ...
    /** Draws the widget.
     ...
     \code
     Widget *s = &scroll;		// scroll is an embedded Fl_Scrollbar
    ...
    /** Sets the background color of the widget. 
     ...
     The default for most widgets is FL_BACKGROUND_COLOR. Use fltk::set_color()
    ...
    /** Gets the font to use. 
     ...
     The function fltk::set_font() can define new typefaces.
     ...
     */
    void callback(Callback* cb, void* p) {callback_=cb; user_data_=p;}
    ...
    /** Sets the current callback function for the widget.
     ...
     \param[in] cb new callback
     */
    void callback(Callback0*cb) {callback_=(Callback*)cb;}
    ...
    /** Sets the current callback function for the widget.
     ...
     \param[in] p user data
     */
    void callback(Callback1*cb, long p=0) {callback_=(Callback*)cb; user_data_=(void*)p;}
    ...
    /** 
     ...
     stored in the widget. This is only used by subclasses of Widget that 
    ...
    /** Gives the widget the keyboard focus.
     Tries to make this widget be the fltk::focus() widget, by first sending 
     it an FL_FOCUS event, and if it returns non-zero, setting 
     fltk::focus() to this widget. You should use this method to 
    ...
    /** Sets the default callback for all widgets.
     ...
     returned by fltk::readqueue(). You may want to call this from your own callback.
     \param[in] cb the new callback
     \param[in] d user data associated with that callback
     \see callback(), do_callback(), fltk::readqueue()
     */
    ...
    // Causes a widget to invoke its callback function with arbitrary arguments.
    // Documentation and implementation in Widget.cxx
...
/ the functions and fuctionalit below must be merged with the file above
#include "Style.h"
#include "Rectangle.h"
