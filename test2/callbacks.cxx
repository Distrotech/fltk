...
// TODO: #include <fltk/IntInput.h>
#include <stdlib.h>
using namespace fltk;

// TODO: IntInput* intinput;

void copy_callback(Widget*, void* v) {
  Slider* slider = (Slider*)v;
// TODO:   slider->value(intinput->ivalue());
}

void down_callback(Widget*, void* v) {
  Slider* slider = (Slider*)v;
// TODO:     slider->value(slider->value()-1);
// TODO:   intinput->value(slider->value());
}
...
int main(int argc, char ** argv) {
  ...
  window.begin();
// TODO:   IntInput intinput(10,10,100,20);
// TODO:   ::intinput = &intinput;
// TODO:   intinput.value(0.0);
  Button copy_button(110, 10, 100, 20, "copy to slider");
  Slider slider(10,35,300,20);
// TODO:     slider.type(Slider::TICK_ABOVE);
// TODO:     slider.clear_flag(LAYOUT_VERTICAL);
  slider.type(FL_HOR_SLIDER); // TODO:
  slider.callback(slider_callback);
  copy_button.callback(copy_callback, &slider);
// TODO:     slider.range(-10,10);
// TODO:     slider.step(1);
// TODO:     slider.value(0);
