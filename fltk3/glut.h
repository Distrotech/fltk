...
//
// "$Id: glut.H 6614 2009-01-01 16:11:32Z matt $"
//
...
//
// End of "$Id: glut.H 6614 2009-01-01 16:11:32Z matt $".
//

/* suggested twin class
// This is the Twin Class to fltk::glut
class glut : public fltk::glut {
public:
  glut(int x, int t, int w, int h, const char *label=0)
  : fltk::glut(x, y, w, h, label), compat_(FLTK1) { }
};
*/
