...
// This is the Twin Class to fltk::forms
class forms : public fltk::forms {
public:
  forms(int x, int t, int w, int h, const char *label=0)
  : fltk::forms(x, y, w, h, label), compat_(FLTK1) { }
};
*/
