...
// This is the Twin Class to fltk::gifImage
class Fl_GIF_Image : public fltk::gifImage {
public:
  Fl_GIF_Image(int x, int t, int w, int h, const char *label=0)
  : fltk::gifImage(x, y, w, h, label), compat_(FLTK1) { }
};
*/
