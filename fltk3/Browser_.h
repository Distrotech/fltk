...
// This is the Twin Class to fltk::browser_
class Fl_Browser_ : public fltk::browser_ {
public:
  Fl_Browser_(int x, int t, int w, int h, const char *label=0)
  : fltk::browser_(x, y, w, h, label), compat_(FLTK1) { }
};
*/
