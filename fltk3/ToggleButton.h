...
// This is the Twin Class to fltk::ToggleButton
class Fl_Toggle_Button : public fltk::ToggleButton {
public:
  Fl_Toggle_Button(int x, int t, int w, int h, const char *label=0)
  : fltk::ToggleButton(x, y, w, h, label), compat_(FLTK1) { }
};
*/
