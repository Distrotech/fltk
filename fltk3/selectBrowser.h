...
// This is the Twin Class to fltk::selectBrowser
class Fl_Select_Browser : public fltk::selectBrowser {
public:
  Fl_Select_Browser(int x, int t, int w, int h, const char *label=0)
  : fltk::selectBrowser(x, y, w, h, label), compat_(FLTK1) { }
};
*/
