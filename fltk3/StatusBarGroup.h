...
// This is the Twin Class to fltk::StatusBarGroup
class Fl_Status_Bar : public fltk::StatusBarGroup {
public:
  Fl_Status_Bar(int x, int t, int w, int h, const char *label=0)
  : fltk::StatusBarGroup(x, y, w, h, label), compat_(FLTK1) { }
};
*/
