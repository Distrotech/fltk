...
// This is the Twin Class to fltk::Flags
class Fl_Flags : public fltk::Flags {
public:
  Fl_Flags(int x, int t, int w, int h, const char *label=0)
  : fltk::Flags(x, y, w, h, label), compat_(FLTK1) { }
};
*/
