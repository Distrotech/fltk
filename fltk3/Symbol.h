...
// This is the Twin Class to fltk::Symbol
class Fl_Symbol : public fltk::Symbol {
public:
  Fl_Symbol(int x, int t, int w, int h, const char *label=0)
  : fltk::Symbol(x, y, w, h, label), compat_(FLTK1) { }
};
*/
