...
// This is the Twin Class to fltk::HelpView
class Fl_Help_View : public fltk::HelpView {
public:
  Fl_Help_View(int x, int t, int w, int h, const char *label=0)
  : fltk::HelpView(x, y, w, h, label), compat_(FLTK1) { }
};
*/
