...
// This is the Twin Class to fltk::pixmap
class Fl_Pixmap : public fltk::pixmap {
public:
  Fl_Pixmap(int x, int t, int w, int h, const char *label=0)
  : fltk::pixmap(x, y, w, h, label), compat_(FLTK1) { }
};
*/
