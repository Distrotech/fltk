...
// This is the Twin Class to fltk::Color
class Fl_Color : public fltk::Color {
public:
  Fl_Color(int x, int t, int w, int h, const char *label=0)
  : fltk::Color(x, y, w, h, label), compat_(FLTK1) { }
};
*/
