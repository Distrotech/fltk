...
// This is the Twin Class to fltk::niceSlider
class Fl_Nice_Slider : public fltk::niceSlider {
public:
  Fl_Nice_Slider(int x, int t, int w, int h, const char *label=0)
  : fltk::niceSlider(x, y, w, h, label), compat_(FLTK1) { }
};
*/
