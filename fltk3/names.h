...
// This is the Twin Class to fltk::names
class names : public fltk::names {
public:
  names(int x, int t, int w, int h, const char *label=0)
  : fltk::names(x, y, w, h, label), compat_(FLTK1) { }
};
*/
