...
//
// "$Id: Fl_Tree.H 7017 2010-01-17 21:54:48Z greg.ercolano $"
//
...
//
// End of "$Id: Fl_Tree.H 7017 2010-01-17 21:54:48Z greg.ercolano $".
//

/* suggested twin class
// This is the Twin Class to fltk::tree
class Fl_Tree : public fltk::tree {
public:
  Fl_Tree(int x, int t, int w, int h, const char *label=0)
  : fltk::tree(x, y, w, h, label), compat_(FLTK1) { }
};
*/
