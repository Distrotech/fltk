...
// This is the Twin Class to fltk::Threads
class Fl_Threads : public fltk::Threads {
public:
  Fl_Threads(int x, int t, int w, int h, const char *label=0)
  : fltk::Threads(x, y, w, h, label), compat_(FLTK1) { }
};
*/
