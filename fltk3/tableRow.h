...
// This is the Twin Class to fltk::tableRow
class Fl_Table_Row : public fltk::tableRow {
public:
  Fl_Table_Row(int x, int t, int w, int h, const char *label=0)
  : fltk::tableRow(x, y, w, h, label), compat_(FLTK1) { }
};
*/
