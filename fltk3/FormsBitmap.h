...
// This is the Twin Class to fltk::formsBitmap
class Fl_FormsBitmap : public fltk::formsBitmap {
public:
  Fl_FormsBitmap(int x, int t, int w, int h, const char *label=0)
  : fltk::formsBitmap(x, y, w, h, label), compat_(FLTK1) { }
};
*/
