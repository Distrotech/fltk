...
// This is the Twin Class to fltk::Monitor
class Fl_Monitor : public fltk::Monitor {
public:
  Fl_Monitor(int x, int t, int w, int h, const char *label=0)
  : fltk::Monitor(x, y, w, h, label), compat_(FLTK1) { }
};
*/
