...
// This is the Twin Class to fltk::bmpImage
class Fl_BMP_Image : public fltk::bmpImage {
public:
  Fl_BMP_Image(int x, int t, int w, int h, const char *label=0)
  : fltk::bmpImage(x, y, w, h, label), compat_(FLTK1) { }
};
*/
