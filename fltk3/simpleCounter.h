...
// This is the Twin Class to fltk::simpleCounter
class Fl_Simple_Counter : public fltk::simpleCounter {
public:
  Fl_Simple_Counter(int x, int t, int w, int h, const char *label=0)
  : fltk::simpleCounter(x, y, w, h, label), compat_(FLTK1) { }
};
*/
