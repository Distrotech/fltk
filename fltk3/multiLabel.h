...
// This is the Twin Class to fltk::multiLabel
class Fl_Multi_Label : public fltk::multiLabel {
public:
  Fl_Multi_Label(int x, int t, int w, int h, const char *label=0)
  : fltk::multiLabel(x, y, w, h, label), compat_(FLTK1) { }
};
*/
