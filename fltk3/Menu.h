...
// This is the Twin Class to fltk::Menu
class Fl_Menu : public fltk::Menu {
public:
  Fl_Menu(int x, int t, int w, int h, const char *label=0)
  : fltk::Menu(x, y, w, h, label), compat_(FLTK1) { }
};
*/
