...
// This is the Twin Class to fltk::WordwrapInput
class Fl_Wordwrap_Input : public fltk::WordwrapInput {
public:
  Fl_Wordwrap_Input(int x, int t, int w, int h, const char *label=0)
  : fltk::WordwrapInput(x, y, w, h, label), compat_(FLTK1) { }
};
*/
