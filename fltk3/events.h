...
// This is the Twin Class to fltk::events
class Fl_Events : public fltk::events {
public:
  Fl_Events(int x, int t, int w, int h, const char *label=0)
  : fltk::events(x, y, w, h, label), compat_(FLTK1) { }
};
*/
