...
// This is the Twin Class to fltk::treePrefs
class Fl_Tree_Prefs : public fltk::treePrefs {
public:
  Fl_Tree_Prefs(int x, int t, int w, int h, const char *label=0)
  : fltk::treePrefs(x, y, w, h, label), compat_(FLTK1) { }
};
*/
