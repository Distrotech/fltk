...
// This is the Twin Class to fltk::Valuator
class Fl_Valuator : public fltk::Valuator {
public:
  Fl_Valuator(int x, int t, int w, int h, const char *label=0)
  : fltk::Valuator(x, y, w, h, label), compat_(FLTK1) { }
};
*/
