...
/**
  ...
  <I>You cannot use fltk::Window as a child of this since the
...
// This is the Twin Class to fltk::ScrollGroup
class Fl_Scroll : public fltk::ScrollGroup {
public:
  Fl_Scroll(int x, int t, int w, int h, const char *label=0)
  : fltk::ScrollGroup(x, y, w, h, label), compat_(FLTK1) { }
};
*/
