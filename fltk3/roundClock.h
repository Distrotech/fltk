...
// This is the Twin Class to fltk::roundClock
class Fl_Round_Clock : public fltk::roundClock {
public:
  Fl_Round_Clock(int x, int t, int w, int h, const char *label=0)
  : fltk::roundClock(x, y, w, h, label), compat_(FLTK1) { }
};
*/
