...
// This is the Twin Class to fltk::showColormap
class fl_show_colormap : public fltk::showColormap {
public:
  fl_show_colormap(int x, int t, int w, int h, const char *label=0)
  : fltk::showColormap(x, y, w, h, label), compat_(FLTK1) { }
};
*/
