...
// This is the Twin Class to fltk::RadioButton
class Fl_Radio_Button : public fltk::RadioButton {
public:
  Fl_Radio_Button(int x, int t, int w, int h, const char *label=0)
  : fltk::RadioButton(x, y, w, h, label), compat_(FLTK1) { }
};
*/
