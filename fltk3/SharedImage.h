...
// This is the Twin Class to fltk::SharedImage
class Fl_Shared_Image : public fltk::SharedImage {
public:
  Fl_Shared_Image(int x, int t, int w, int h, const char *label=0)
  : fltk::SharedImage(x, y, w, h, label), compat_(FLTK1) { }
};
*/
