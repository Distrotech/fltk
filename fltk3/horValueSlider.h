...
// This is the Twin Class to fltk::horValueSlider
class Fl_Hor_Value_Slider : public fltk::horValueSlider {
public:
  Fl_Hor_Value_Slider(int x, int t, int w, int h, const char *label=0)
  : fltk::horValueSlider(x, y, w, h, label), compat_(FLTK1) { }
};
*/
