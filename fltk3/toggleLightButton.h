...
// This is the Twin Class to fltk::toggleLightButton
class Fl_Toggle_Light_Button : public fltk::toggleLightButton {
public:
  Fl_Toggle_Light_Button(int x, int t, int w, int h, const char *label=0)
  : fltk::toggleLightButton(x, y, w, h, label), compat_(FLTK1) { }
};
*/
