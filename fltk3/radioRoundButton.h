...
// This is the Twin Class to fltk::radioRoundButton
class Fl_Radio_Round_Button : public fltk::radioRoundButton {
public:
  Fl_Radio_Round_Button(int x, int t, int w, int h, const char *label=0)
  : fltk::radioRoundButton(x, y, w, h, label), compat_(FLTK1) { }
};
*/
