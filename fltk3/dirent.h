...
// This is the Twin Class to fltk::dirent
class dirent : public fltk::dirent {
public:
  dirent(int x, int t, int w, int h, const char *label=0)
  : fltk::dirent(x, y, w, h, label), compat_(FLTK1) { }
};
*/
