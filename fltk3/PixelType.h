...
// This is the Twin Class to fltk::PixelType
class Fl_Pixel_Type : public fltk::PixelType {
public:
  Fl_Pixel_Type(int x, int t, int w, int h, const char *label=0)
  : fltk::PixelType(x, y, w, h, label), compat_(FLTK1) { }
};
*/
