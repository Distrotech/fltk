...
//
// "$Id: Fl_PNM_Image.H 6614 2009-01-01 16:11:32Z matt $"
//
...
//
// End of "$Id: Fl_PNM_Image.H 6614 2009-01-01 16:11:32Z matt $".
//

/* suggested twin class
// This is the Twin Class to fltk::pnmImage
class Fl_PNM_Image : public fltk::pnmImage {
public:
  Fl_PNM_Image(int x, int t, int w, int h, const char *label=0)
  : fltk::pnmImage(x, y, w, h, label), compat_(FLTK1) { }
};
*/
