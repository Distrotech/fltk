...
// This is the Twin Class to fltk::horFillSlider
class Fl_Hor_Fill_Slider : public fltk::horFillSlider {
public:
  Fl_Hor_Fill_Slider(int x, int t, int w, int h, const char *label=0)
  : fltk::horFillSlider(x, y, w, h, label), compat_(FLTK1) { }
};
*/
