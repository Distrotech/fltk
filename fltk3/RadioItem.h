...
// This is the Twin Class to fltk::RadioItem
class Fl_Radio_Item : public fltk::RadioItem {
public:
  Fl_Radio_Item(int x, int t, int w, int h, const char *label=0)
  : fltk::RadioItem(x, y, w, h, label), compat_(FLTK1) { }
};
*/
