...
//
// "$Id: Fl_Menu_.H 7150 2010-02-26 13:03:21Z matt $"
//
...
//
// End of "$Id: Fl_Menu_.H 7150 2010-02-26 13:03:21Z matt $".
//

/* suggested twin class
// This is the Twin Class to fltk::menu_
class Fl_Menu_ : public fltk::menu_ {
public:
  Fl_Menu_(int x, int t, int w, int h, const char *label=0)
  : fltk::menu_(x, y, w, h, label), compat_(FLTK1) { }
};
*/
