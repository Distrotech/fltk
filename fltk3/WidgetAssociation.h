...
// This is the Twin Class to fltk::WidgetAssociation
class Fl_Widget_Assiciation : public fltk::WidgetAssociation {
public:
  Fl_Widget_Assiciation(int x, int t, int w, int h, const char *label=0)
  : fltk::WidgetAssociation(x, y, w, h, label), compat_(FLTK1) { }
};
*/
