...
// This is the Twin Class to fltk::horNicesSlide
class Fl_Hor_Nice_Slider : public fltk::horNicesSlide {
public:
  Fl_Hor_Nice_Slider(int x, int t, int w, int h, const char *label=0)
  : fltk::horNicesSlide(x, y, w, h, label), compat_(FLTK1) { }
};
*/
