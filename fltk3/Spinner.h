...
// This is the Twin Class to fltk::Spinner
class Fl_Spinner : public fltk::Spinner {
public:
  Fl_Spinner(int x, int t, int w, int h, const char *label=0)
  : fltk::Spinner(x, y, w, h, label), compat_(FLTK1) { }
};
*/
