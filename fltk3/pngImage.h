...
//
// "$Id: Fl_PNG_Image.H 6614 2009-01-01 16:11:32Z matt $"
//
...
//
// End of "$Id: Fl_PNG_Image.H 6614 2009-01-01 16:11:32Z matt $".
//

/* suggested twin class
// This is the Twin Class to fltk::pngImage
class Fl_PNG_Image : public fltk::pngImage {
public:
  Fl_PNG_Image(int x, int t, int w, int h, const char *label=0)
  : fltk::pngImage(x, y, w, h, label), compat_(FLTK1) { }
};
*/
