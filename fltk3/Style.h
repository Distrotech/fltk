...
// This is the Twin Class to fltk::Style
class Fl_Style : public fltk::Style {
public:
  Fl_Style(int x, int t, int w, int h, const char *label=0)
  : fltk::Style(x, y, w, h, label), compat_(FLTK1) { }
};
*/
