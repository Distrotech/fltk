...
// This is the Twin Class to fltk::input_
class Fl_Input_ : public fltk::input_ {
public:
  Fl_Input_(int x, int t, int w, int h, const char *label=0)
  : fltk::input_(x, y, w, h, label), compat_(FLTK1) { }
};
*/
