...
//
// "$Id: Fl_Preferences.H 7117 2010-02-20 21:14:47Z matt $"
//
// Preferences .
//
...
//
// End of "$Id: Fl_Preferences.H 7117 2010-02-20 21:14:47Z matt $".
//

/* suggested twin class
// This is the Twin Class to fltk::Preferences
class Fl_Preferences : public fltk::Preferences {
public:
  Fl_Preferences(int x, int t, int w, int h, const char *label=0)
  : fltk::Preferences(x, y, w, h, label), compat_(FLTK1) { }
};
*/
