...
// This is the Twin Class to fltk::ShapedWindow
class Fl_Shaped_Window : public fltk::ShapedWindow {
public:
  Fl_Shaped_Window(int x, int t, int w, int h, const char *label=0)
  : fltk::ShapedWindow(x, y, w, h, label), compat_(FLTK1) { }
};
*/
