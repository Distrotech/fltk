...
// This is the Twin Class to fltk::Font
class Fl_Font : public fltk::Font {
public:
  Fl_Font(int x, int t, int w, int h, const char *label=0)
  : fltk::Font(x, y, w, h, label), compat_(FLTK1) { }
};
*/
