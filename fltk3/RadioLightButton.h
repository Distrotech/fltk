...
// This is the Twin Class to fltk::RadioLightButton
class Fl_Radio_Light_Button : public fltk::RadioLightButton {
public:
  Fl_Radio_Light_Button(int x, int t, int w, int h, const char *label=0)
  : fltk::RadioLightButton(x, y, w, h, label), compat_(FLTK1) { }
};
*/
