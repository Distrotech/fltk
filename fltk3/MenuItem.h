...
// This is the Twin Class to fltk::menuItem
class Fl_Menu_Item : public fltk::menuItem {
public:
  Fl_Menu_Item(int x, int t, int w, int h, const char *label=0)
  : fltk::menuItem(x, y, w, h, label), compat_(FLTK1) { }
};
*/
