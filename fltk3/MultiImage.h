...
// This is the Twin Class to fltk::MultiImage
class Fl_Multi_Image : public fltk::MultiImage {
public:
  Fl_Multi_Image(int x, int t, int w, int h, const char *label=0)
  : fltk::MultiImage(x, y, w, h, label), compat_(FLTK1) { }
};
*/
