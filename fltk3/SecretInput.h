...
// This is the Twin Class to fltk::SecretInput
class Fl_Secret_Input : public fltk::SecretInput {
public:
  Fl_Secret_Input(int x, int t, int w, int h, const char *label=0)
  : fltk::SecretInput(x, y, w, h, label), compat_(FLTK1) { }
};
*/
