...
// This is the Twin Class to fltk::Adjuster
class Fl_Adjuster : public fltk::Adjuster {
public:
  Fl_Adjuster(int x, int t, int w, int h, const char *label=0)
  : fltk::Adjuster(x, y, w, h, label), compat_(FLTK1) { }
};
*/
