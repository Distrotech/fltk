...
// This is the Twin Class to fltk::AnsiWidget
class Fl_Ansi_Widget : public fltk::AnsiWidget {
public:
  Fl_Ansi_Widget(int x, int t, int w, int h, const char *label=0)
  : fltk::AnsiWidget(x, y, w, h, label), compat_(FLTK1) { }
};
*/
