...
// This is the Twin Class to fltk::checkBrowser
class Fl_Check_Browser : public fltk::checkBrowser {
public:
  Fl_Check_Browser(int x, int t, int w, int h, const char *label=0)
  : fltk::checkBrowser(x, y, w, h, label), compat_(FLTK1) { }
};
*/
