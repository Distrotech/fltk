...
// This is the Twin Class to fltk::nativeFileChooserFLTK
class Fl_Native_File_Chooser_FLTK : public fltk::nativeFileChooserFLTK {
public:
  Fl_Native_File_Chooser_FLTK(int x, int t, int w, int h, const char *label=0)
  : fltk::nativeFileChooserFLTK(x, y, w, h, label), compat_(FLTK1) { }
};
*/
