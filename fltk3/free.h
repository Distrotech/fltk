...
// This is the Twin Class to fltk::free
class Fl_Free : public fltk::free {
public:
  Fl_Free(int x, int t, int w, int h, const char *label=0)
  : fltk::free(x, y, w, h, label), compat_(FLTK1) { }
};
*/
