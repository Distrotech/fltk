...
//
// "$Id: Fl_Table.H 7117 2010-02-20 21:14:47Z matt $"
//
...
//
// End of "$Id: Fl_Table.H 7117 2010-02-20 21:14:47Z matt $".
//

/* suggested twin class
// This is the Twin Class to fltk::table
class Fl_Table : public fltk::table {
public:
  Fl_Table(int x, int t, int w, int h, const char *label=0)
  : fltk::table(x, y, w, h, label), compat_(FLTK1) { }
};
*/
