...
// This is the Twin Class to fltk::Rectangle
class Fl_Rectangle : public fltk::Rectangle {
public:
  Fl_Rectangle(int x, int t, int w, int h, const char *label=0)
  : fltk::Rectangle(x, y, w, h, label), compat_(FLTK1) { }
};
*/
