...
// This is the Twin Class to fltk::horSlider
class Fl_Hor_Slider : public fltk::horSlider {
public:
  Fl_Hor_Slider(int x, int t, int w, int h, const char *label=0)
  : fltk::horSlider(x, y, w, h, label), compat_(FLTK1) { }
};
*/
