...
// This is the Twin Class to fltk::InputBrowser
class Fl_Input_Browser : public fltk::InputBrowser {
public:
  Fl_Input_Browser(int x, int t, int w, int h, const char *label=0)
  : fltk::InputBrowser(x, y, w, h, label), compat_(FLTK1) { }
};
*/
