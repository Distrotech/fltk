...
//
/** \file PostScript.h 
 \brief declaration of classes fltk3::PostScriptGraphicsDriver, fltk3::PostScriptFileDevice.
 */
...
namespace fltk3 {
  ...
  public: 
    ...
    int start_postscript (int pagecount, enum fltk3::PagedDevice::Page_Format format, enum fltk3::PagedDevice::Page_Layout layout);
    ...
    enum fltk3::PagedDevice::Page_Format page_format_;
    char *ps_filename_;
    ...
    //fltk3::PostScriptGraphicsDriver(FILE *o, int lang_level, int pages = 0); // ps (also multi-page) constructor
    //fltk3::PostScriptGraphicsDriver(FILE *o, int lang_level, int x, int y, int w, int h); //eps constructor
    ...
    void draw_image(fltk3::DrawImageCb call, void* data, int x,int y, int w, int h, int delta=3);
