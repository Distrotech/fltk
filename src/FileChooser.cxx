...
// Code for //\n// "$Id: FileChooser.fl 4723 2005-12-30 10:13...
#include <fltk/draw.h>
#include <fltk/run.h>
    ...
    o->begin();
     {fltk::Group* o = new fltk::Group(10, 10, 470, 25);
      o->begin();
       ...
       {fltk::PopupMenu* o = favoritesButton = new fltk::PopupMenu(280, 0, 155, 25, "Favorites");
       ...
       {fltk::Button* o = newButton = new fltk::Button(445, 0, 25, 25, "button");
     ...
     {fltk::Group* o = new fltk::Group(10, 275, 470, 95);
      o->begin();
       ...
       {fltk::FileInput* o = fileName = new fltk::FileInput(105, 25, 365, 35, "file:");
        o->labelfont(fltk::HELVETICA_BOLD);
...
// Code for //\n// End of "$Id: FileChooser.fl 4723 2005-12-3...
