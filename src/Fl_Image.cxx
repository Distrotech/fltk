...
/**
  ...
  the case of fltk::SharedImage, released) when you are done
  with it.
*/
...
/**
  ...
  fltk::Widget and Fl_Menu_Item classes
  instead.
*/
void Fl_Image::label(fltk::Widget* widget) {
  widget->image(this);
}
...
void Fl_RGB_Image::label(fltk::Widget* widget) {
  widget->image(this);
}
