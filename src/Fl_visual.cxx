...
/** \fn  fltk::visual(int flags)
    ...
    available.
    <BR>&nbsp; </LI>
    <LI>fltk::visual(FL_DOUBLE|FL_INDEX)
    <BR>Hardware double buffering.  Call this if you are going to use 
    Fl_Double_Window.
    <BR>&nbsp; </LI>
    <LI>fltk::visual(FL_DOUBLE|FL_RGB)</LI>
    <LI>fltk::visual(FL_DOUBLE|FL_RGB8)
