...
*/    
void fltk::set_font(Fl_Font fnum, const char* name) {
...
void fltk::set_font(Fl_Font fnum, Fl_Font from) {
  fltk::set_font(fnum, get_font(from));
}
/**
    ...
    of this face.
*/
const char* fltk::get_font(Fl_Font fnum) {return fl_fonts[fnum].name;}
