...
*/
int fltk::draw_box_active() { return draw_it_active; }
...
/**
  ...
  \see box_dy()
*/
int fltk::box_dx(Fl_Boxtype t) {return fl_box_table[t].dx;}
...
/**
    ...
    \code
         int X = yourwidget->x() + fltk::box_dx(yourwidget->box());
         int Y = yourwidget->y() + fltk::box_dy(yourwidget->box());
         int W = yourwidget->w() - fltk::box_dw(yourwidget->box());
         int H = yourwidget->h() - fltk::box_dh(yourwidget->box());
    \endcode
...
*/
int fltk::box_dy(Fl_Boxtype t) {return fl_box_table[t].dy;}

/**
  Returns the width offset for the given boxtype.
  \see box_dy().
*/
int fltk::box_dw(Fl_Boxtype t) {return fl_box_table[t].dw;}

/**
  Returns the height offset for the given boxtype.
  \see box_dy().
*/
int fltk::box_dh(Fl_Boxtype t) {return fl_box_table[t].dh;}
...
Fl_Box_Draw_F *fltk::get_boxtype(Fl_Boxtype t) {
  return fl_box_table[t].f;
}
/** Sets the function to call to draw a specific boxtype. */
void fltk::set_boxtype(Fl_Boxtype t, Fl_Box_Draw_F* f,
...
void fltk::set_boxtype(Fl_Boxtype to, Fl_Boxtype from) {
...
//extern fltk::Widget *fl_boxcheat; // hack set by Fl_Window.cxx
/** Draws the widget box according its box style */
void fltk::Widget::draw_box() const {
  int t = box_;
  if (!t) return;
//   if (this == fl_boxcheat) {
//     fl_boxcheat = 0;
...
void fltk::Widget::draw_box(Fl_Boxtype t, Fl_Color c) const {
  draw_box(t, x_, y_, w_, h_, c);
}
/** Draws a box of type t, of color c at the position X,Y and size W,H. */
void fltk::Widget::draw_box(Fl_Boxtype t, int X, int Y, int W, int H, Fl_Color c) const {
