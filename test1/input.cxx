...
// TODO: #include <FL/Fl_Color_Chooser.H>
...
void test(Fl_Input *i) {
  if (i->changed()) {
    ...
    char utf8buf[10];
// TODO:      int last = fl_utf8encode(i->index(i->position()), utf8buf);
// TODO:      utf8buf[last] = 0;
// TODO:      printf("Symbol at cursor position: %s\n", utf8buf);
  }
}
...
// TODO:    uchar r,g,b; Fl::get_color(c, r,g,b);
// TODO:    if (fl_color_chooser(0,r,g,b)) {
// TODO:      Fl::set_color(c,r,g,b); Fl::redraw();
// TODO:      button->labelcolor(fl_contrast(FL_BLACK,c));
// TODO:      button->redraw();
// TODO:    }
}
...
// TODO:    b->value(input[4]->tab_nav() ? 1 : 0);
...
// TODO:    b->value(input[4]->tab_nav() ? 1 : 0);
// TODO:    b->value(Fl::option(Fl::OPTION_ARROW_FOCUS) ? 1 : 0);
...
// TODO:  b->color(input[0]->textcolor()); b->callback(color_cb, (void*)2);
  b->labelcolor(fl_contrast(FL_BLACK,b->color()));
