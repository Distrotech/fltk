...
public:
    void draw();
    int handle(int);
    Fl_Value_Slider(int x,int y,int w,int h, char *l = 0);
...
//
// End of "$Id: value_slider.d 4288 2005-04-16 00:13:17Z mike $".
//
    End of automatic import -+/
/+- This file was imported from C++ using a script
//
// "$Id: value_slider.d 5190 2006-06-09 16:16:34Z mike $"
//
...
Fl_Value_Slider.Fl_Value_Slider(int X, int Y, int W, int H, char*l)
: Fl_Slider(X,Y,W,H,l) {
  step(1,100);
