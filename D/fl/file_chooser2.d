...
//
// "$Id: file_chooser2.d 5190 2006-06-09 16:16:34Z mike $"
//
...
static int	compare_dirnames(char *a, char *b);
static void	quote_pathname(char *, char *, int);
static void	unquote_pathname(char *, char *, int);
...
Fl_File_Chooser.count() {
  ...
  char	*filename;	// Filename in input field or list
...
void
Fl_File_Chooser.directory(char *d)// I - Directory to change to
{
...
void
Fl_File_Chooser.filter(char *p)		// I - Pattern(s)
{
...
Fl_File_Chooser.update_preview()
{
  ...
  if (!image) {
    ...
    if (*ptr || ptr == preview_text_) {
      ...
      previewBox.alignment(FL_ALIGN_CLIP);
      ...
      previewBox.alignment((Fl_Align)(FL_ALIGN_CLIP | FL_ALIGN_INSIDE |
                                   FL_ALIGN_LEFT | FL_ALIGN_TOP));
      previewBox.labelsize((ubyte)size);
...
void
Fl_File_Chooser.value(char *filename)
...
static int
compare_dirnames(char *a, char *b) {
  int alen, blen;
...
//
// End of "$Id: file_chooser2.d 5190 2006-06-09 16:16:34Z mike $".
//
