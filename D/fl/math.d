...
// in the project)
version (__APPLE__) && defined(__PROJECTBUILDER__) {
...
const int M_PI_2 = 1.57079632679489661923; 
const int M_PI_4 = 0.78539816339744830962; 
const int M_1_PI = 0.31830988618379067154; 
const int M_2_PI = 0.63661977236758134308; 
} // !M_PI

version (!M_SQRT2) {
const int M_SQRT2 = 1.41421356237309504880; 
const int M_SQRT1_2 = 0.70710678118654752440; 
} // !M_SQRT2

#  if (defined(WIN32) || defined(CRAY)) && !defined(__MINGW32__) && !defined(__MWERKS__)

double rint(double v) {return floor(v+.5);}
double copysign(double a, double b) {return b<0 ? -a : a;}

} // (WIN32 || CRAY) && !__MINGW32__ && !__MWERKS__
