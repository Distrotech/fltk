...
//
// "$Id: gl_overlay.d 5350 2006-08-23 17:40:54Z mike $"
//
...
class _Fl_Gl_Overlay : Fl_Gl_Window {
  void flush();
  void draw();
public:
  void show();
...
void Fl_Gl_Window.make_overlay() {
  ...
  if (!pfd.iPixelType) {
    ...
    for (int i = 0; i <= n; i++) {
      ubyte r,g,b; Fl.get_color((Fl_Color)i,r,g,b);
      palette[i] = RGB(r,g,b);
    }
...
//
// End of "$Id: gl_overlay.d 5350 2006-08-23 17:40:54Z mike $".
//
