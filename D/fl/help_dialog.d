...
//
// "$Id: help_dialog.d 4582 2005-09-25 16:54:40Z matt $"
//
...
//
// End of "$Id: help_dialog.d 4582 2005-09-25 16:54:40Z matt $".
//
    End of automatic import -+/
/+- This file was imported from C++ using a script
//
// "$Id: help_dialog.d 5190 2006-06-09 16:16:34Z mike $"
//
// Fl_Help_Dialog dialog for the Fast Light Tool Kit (FLTK).
//
// Copyright 1998-2005 by Bill Spitzak and others.
...
void Fl_Help_Dialog.load(char *f) {
  view_.set_changed();
view_.load(f);
window_.label(view_.title());
}
...
void Fl_Help_Dialog.textsize(ubyte s) {
  view_.textsize(s);
...
ubyte Fl_Help_Dialog.textsize() {
  return (view_.textsize());
}

void Fl_Help_Dialog.topline(char *n) {
  view_.topline(n);
}
...
void Fl_Help_Dialog.value(char *f) {
  view_.set_changed();
view_.value(f);
window_.label(view_.title());
}
...
//
// End of "$Id: help_dialog.d 5190 2006-06-09 16:16:34Z mike $".
//
    End of automatic import -+/
