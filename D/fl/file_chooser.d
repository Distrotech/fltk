...
//
// "$Id: file_chooser.d 4875 2006-03-28 15:24:14Z matt $"
//
...
private:
  ...
  void update_preview();
public:
  Fl_File_Chooser(char *d, char *p, int t, char *title);
private:
...
public:
  ...
  char * ok_label();
  void preview(int e);
  int preview() { return previewButton.value(); };
  void rescan();
  ...
  int visible();
  static char *add_favorites_label;
  static char *all_files_label;
  static char *custom_filter_label;
  static char *existing_file_label;
  static char *favorites_label;
  static char *filename_label;
  static char *filesystems_label;
  static char *manage_favorites_label;
  static char *new_directory_label;
  static char *new_directory_tooltip;
  static char *preview_label;
  static char *save_label;
  static char *show_label;
  static Fl_File_Sort_F  sort;
};
char *fl_dir_chooser(char *message,char *fname,int relative=0);
char *fl_file_chooser(char *message,char *pat,char *fname,int relative=0);
void fl_file_chooser_callback(void (*cb)(char*));
void fl_file_chooser_ok_label(char*l);
}

//
// End of "$Id: file_chooser.d 4875 2006-03-28 15:24:14Z matt $".
//
    End of automatic import -+/
/+- This file was imported from C++ using a script
//
// "$Id: file_chooser.d 5190 2006-06-09 16:16:34Z mike $"
//
// Fl_File_Chooser dialog for the Fast Light Tool Kit (FLTK).
//
// Copyright 1998-2005 by Bill Spitzak and others.
...
Fl_File_Chooser.Fl_File_Chooser(char *d, char *p, int t, char *title) {
  Fl_Double_Window  w;
  { Fl_Double_Window  o = window = new Fl_Double_Window(490, 380, "Choose File");
    ...
    { Fl_Group  o = new Fl_Group(10, 10, 470, 25);
      ...
      { Fl_Menu_Button  o = favoritesButton = new Fl_Menu_Button(290, 10, 155, 25, "Favorites");
        ...
        o.alignment(FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
    ...
    { Fl_Tile  o = new Fl_Tile(10, 45, 470, 225);
      ...
      { Fl_Box  o = previewBox = new Fl_Box(305, 45, 175, 225, "?");
        o.box(FL_DOWN_BOX);
        o.labelsize(100);
        o.alignment(FL_ALIGN_CLIP|FL_ALIGN_INSIDE);
      }
      o.end();
      Fl_Group.current()->resizable(o);
    }
    { Fl_Group  o = new Fl_Group(10, 275, 470, 95);
      ...
      { Fl_Box  o = new Fl_Box(10, 310, 105, 25, "Filename:");
        o.labelfont(1);
        o.alignment(FL_ALIGN_RIGHT|FL_ALIGN_INSIDE);
...
void Fl_File_Chooser.iconsize(ubyte s) {
  fileList.iconsize(s);
}

ubyte Fl_File_Chooser.iconsize() {
  return (fileList.iconsize());
}

void Fl_File_Chooser.label(char *l) {
  window.label(l);
}
...
void Fl_File_Chooser.ok_label(char *l) {
  okButton.label(l);
int w=0, h=0;
...
void Fl_File_Chooser.textfont(ubyte f) {
  fileList.textfont(f);
}

ubyte Fl_File_Chooser.textfont() {
  return (fileList.textfont());
}

void Fl_File_Chooser.textsize(ubyte s) {
  fileList.textsize(s);
}

ubyte Fl_File_Chooser.textsize() {
...
void * Fl_File_Chooser.user_data() {
  return (data_);
}
...
//
// End of "$Id: file_chooser.d 5190 2006-06-09 16:16:34Z mike $".
//
    End of automatic import -+/
