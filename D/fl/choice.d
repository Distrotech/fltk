// "$Id: choice.d 4288 2005-04-16 00:13:17Z mike $"
//
...
void Fl_Choice.draw() {
  ...
  if (mvalue()) {
    ...
    if ( Fl.scheme()) {
      ...
      l.deimage = 0;
      l.type = m.labeltype_;
      l.font = m.labelsize_ || m.labelfont_ ? m.labelfont_ : ubyte(textfont());
...
int Fl_Choice.value(int v) {
  if (v == -1) return value((Fl_Menu_Item *)0);
...
//
// End of "$Id: choice.d 5190 2006-06-09 16:16:34Z mike $".
//
    End of automatic import -+/
