...
package:
 ...
 this(int X, int Y, int W, int H, char* L=null) {
  ...
  package int flags() {return flags_;}
  ...
  int INVISIBLE=2;
  int OUTPUT=4;
  int SHORTCUT_LABEL=64;
  int CHANGED=128;
  int VISIBLE_FOCUS=512;
  int COPIED_LABEL = 1024;
...
public:
  ...
  void color(uint a) {color_ = a;}
  Fl_Color selection_color() {return color2_;}
  void selection_color(uint a) {color2_ = a;}
  void color(uint a, uint b) {color_=a; color2_=b;}

  char* label() {return label_.value;}
  ...
  Fl_Color labelcolor() {return label_.color;}
  void labelcolor(uint a) {label_.color=a;}
  Fl_Font labelfont() {return label_.font;}
  void labelfont(ubyte a) {label_.font=a;}
  ubyte labelsize() {return label_.size;}
  void labelsize(ubyte a) {label_.size=a;}
  ...
  int visible() {return !(flags_&INVISIBLE);}
  int visible_r() {
  ...
  int active() {return !(flags_&INACTIVE);}
  ...
  int takesevents() {return !(flags_&(INACTIVE|INVISIBLE|OUTPUT));}
  ...
  int contains(Fl_Widget o) {
    for (; o; o = o.parent_) if (o is this) return 1;
    return 0;
  }

  int inside(Fl_Widget  o) {return o ? o.contains(this) : 0;}
  ...
  ubyte damage() {return damage_;}
  void clear_damage(ubyte c=0) {damage_ = c;}

  void damage(ubyte fl) {
    if (type() < FL_WINDOW) {
  ...
  void damage(ubyte fl, int X, int Y, int W, int H) {
    Fl_Widget wi = this;
  ...
  Fl_Color color2() {return color2_;}
