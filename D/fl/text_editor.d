...
//
// "$Id: text_editor.d 4288 2005-04-16 00:13:17Z mike $"
//
...
version (!FL_TEXT_EDITOR_H) {
#define FL_TEXT_EDITOR_H

public import fl.text_display;

// key will match in any state
const int FL_TEXT_EDITOR_ANY_STATE = (-1L); 

class Fl_Text_Editor : Fl_Text_Display {
  public:
    alias int (*Key_Func)(int key, Fl_Text_Editor  editor);
    ...
    Fl_Text_Editor(int X, int Y, int W, int H, char* l = 0);
...
//
// End of "$Id: text_editor.d 4288 2005-04-16 00:13:17Z mike $".
//

    End of automatic import -+/
/+- This file was imported from C++ using a script
//
// "$Id: text_editor.d 5325 2006-08-17 11:10:54Z matt $"
//
// Copyright 2001-2005 by Bill Spitzak and others.
// Original code Copyright Mark Edel.  Permission to distribute under
// the LGPL for the FLTK library granted by Mark Edel.
...
#include <ctype.h>
#include <FL/Fl.H>
private import fl.text_editor;
private import fl.ask;


Fl_Text_Editor.Fl_Text_Editor(int X, int Y, int W, int H,  char* l)
...
//
// End of "$Id: text_editor.d 5325 2006-08-17 11:10:54Z matt $".
//
    End of automatic import -+/
