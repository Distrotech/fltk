...
alias UInt32	ItemCount;
alias UInt32	DragReference;
alias SInt32	CGWindowLevel;

alias ushort	CGGlyph;

alias void* PicPtr;
alias void* RgnHandle;
alias void* PixPatPtr;
alias void* MenuRef;
alias void* Collection;
alias void* PicHandle;
alias void* AliasHandle;
alias void* IconRef;
alias void* HIToolbarRef;
alias void* FSRef;
alias void* EventRef;
alias void* CFDictionaryRef;
alias void* CFImageRef;
alias void* CGImageRef;
alias void* CGPDFDocumentRef;
alias void* CGPDFPageRef;
alias void* CGShadingRef;
alias void* CGColorSpaceRef;
alias void* CGColorRef;
...
alias UInt16 MenuItemIndex;

alias ushort EventMask;
alias ushort EventKind;
alias ushort EventModifiers;
struct EventRecord {
   EventKind what;
   uint message;
   uint when;
...
alias OSErr function(AppleEventRef, AppleEventRef, UInt32) AEEventHandlerProcPtr;
alias AEEventHandlerProcPtr AEEventHandlerUPP;

typedef OSStatus function(EventHandlerCallRef, EventRef, void*) EventHandlerProcPtr;
